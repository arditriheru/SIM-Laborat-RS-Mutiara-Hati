...
<head>
	...
	<title>RS Mutiara Hati | Login</title>
	<!-- Login page CSS -->
...
<body>
	...
	if (isset($_POST['loginsubmit'])){
		...
		$a = mysqli_query($koneksi,"SELECT id_petugas, nama_petugas
			FROM psdi_petugas
		...
		if($cek > 0){
			...
			echo "<script>alert('Username / Password Salah');document.location='javascript: history.back()'</script>";
		}
	}
	?>
